<div class="main-nav">
     ...
     <div class="scrollbar" data-simplebar>
          ...
          <ul class="navbar-nav" id="navbar-nav">
               ...
               <li class="nav-item">
                    <a class="nav-link" href="/drones/index">
                         <span class="nav-icon">


<!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
<svg fill="#ffffffff" width="24px" height="24px" viewBox="0 0 64 64" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<path d="M25.6,48c-0.5,0.3-0.6,0.9-0.3,1.4c1.5,2.3,4,3.6,6.7,3.6s5.2-1.3,6.7-3.6c0.3-0.5,0.2-1.1-0.3-1.4    c-0.5-0.3-1.1-0.2-1.4,0.3C35.9,50,34,51,32,51s-3.9-1-5-2.7C26.7,47.8,26.1,47.7,25.6,48z"/>
...
<path d="M32,34c1.7,0,3-1.3,3-3s-1.3-3-3-3s-3,1.3-3,3S30.3,34,32,34z M32,30c0.6,0,1,0.4,1,1s-0.4,1-1,1s-1-0.4-1-1    S31.4,30,32,30z"/>
...
<g id="satelite_dish"/>
                         ...
                         <span class="nav-text"> Drones </span>
                              ...
                              <li class="nav-item">
                    <a class="nav-link" href="/ambulancias">
                         <span class="nav-icon">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 7a2 2 0 1 1-4 0a2 2 0 0 1 4 0Z"/><path stroke-linecap="round" d="M18 10s-3.537 1.5-6 1.5S6 10 6 10m6 2v1.452m0 0a3 3 0 0 0 .476 1.623L15 19m-3-5.548a3 3 0 0 1-.476 1.623L9 19"/><path stroke-linecap="round" d="M7 3.338A9.95 9.95 0 0 1 12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12c0-1.821.487-3.53 1.338-5"/></g></svg>                         </span>
                         <span class="nav-text"> Ambulancias </span>
                    </a>
               </li>
