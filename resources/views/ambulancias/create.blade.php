@extends('layouts.vertical', ['title' => 'Nueva Ambulancia'])
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="page-header">
        <h2 style="color: white;">Registrar Nueva Ambulancia</h2>
        <p class="subtitle">Agregar unidad móvil al sistema</p>
    </div>
        ...
        <form action="{{ route('ambulancias.store') }}" method="POST">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="help-text">Estado inicial de disponibilidad de la unidad</div>
                </div>
            </div>
